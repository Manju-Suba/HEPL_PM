...
<?php $component->withAttributes(['type' => 'secondary']); ?>
                    <ul>
                        <li class="py-2"> &bull;
                            <b><?php echo app('translator')->get('app.storageSetting.local'); ?></b> <?php echo app('translator')->get('app.storageSetting.localStorageNote'); ?></li>
...
<?php $component->withAttributes([]); ?>
                            ...
                            <option value="aws_s3"
                                    data-content="<img src='<?php echo e(asset('img/aws_s3.svg')); ?>' width='20' height='20' /> <?php echo app('translator')->get('app.storageSetting.aws'); ?>"
                            ...
                            <option value="digitalocean"
                                data-content="<img src='<?php echo e(asset('img/digitalocean.svg')); ?>' width='20' height='20' /> DigitalOcean Spaces"
                                <?php if(isset($digitalOceanCredentials) && $digitalOceanCredentials->status == 'enabled'): ?> selected <?php endif; ?>>
                                DigitalOcean Spaces
                            </option>

                            <option value="wasabi"
                                data-content="<img src='<?php echo e(asset('img/wasabi.svg')); ?>' width='20' height='20' /> Wasabi"
                            <?php if(isset($wasabiCredentials) && $wasabiCredentials->status == 'enabled'): ?> selected <?php endif; ?>>
                                Wasabi
                            </option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php echo $__env->make('storage-settings.wasabi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'test-aws','class' => 'wasabi-form mr-3']); ?>
                            <?php echo app('translator')->get('app.storageSetting.testWasabi'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal145d6f964f40dbb2191316e2895f0c633dbd4d26)): ?>
<?php $component = $__componentOriginal145d6f964f40dbb2191316e2895f0c633dbd4d26; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/storage-settings/index.blade.php ENDPATH**/ ?>