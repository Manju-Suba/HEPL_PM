...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'table-bordered table-hover rounded','id' => 'active-timer-table']); ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/timelogs/ajax/active_timer.blade.php ENDPATH**/ ?>