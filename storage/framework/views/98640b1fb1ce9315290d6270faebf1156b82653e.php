...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.tasks.taskCategory'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td data-row-id="<?php echo e($category->id); ?>" contenteditable="true"><?php echo e(mb_ucwords($category->category_name)); ?></td>
                <td class="text-right">
                    <?php if($deleteTaskCategoryPermission == 'all' || $deleteTaskCategoryPermission == 'added'): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createTaskCategory']); ?>
...
<script>
    $('.delete-category').click(function() {
        ...
        var url = "<?php echo e(route('taskCategory.destroy', ':id')); ?>";
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('taskCategory.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('taskCategory.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /var/www/HEPL_PM/resources/views/tasks/create_category.blade.php ENDPATH**/ ?>