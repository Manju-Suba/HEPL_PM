<?php if(in_array('internship_date', $activeWidgets)): ?>
    <?php
...
<?php endif; ?>
                                ...
                                <td class="pr-20 text-right">
                                    ...
                                    <?php if($internshipDate->setTimezone(company()->timezone)->isToday()): ?>
                                        <span
                                            class="text-success f-12"><?php echo app('translator')->get('messages.internshipMessage'); ?><?php echo e($internshipDate->format($company->date_format)); ?></span>
                                    <?php elseif($internshipDate->diffInDays($currentDay) <= 7): ?>
                                        <span class="text-warning f-12"><?php echo app('translator')->get('messages.internshipMessage'); ?>
                                            <?php echo e($internshipDate->format($company->date_format)); ?></span>
                                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /var/www/HEPL_PM/resources/views/dashboard/employee/widgets/internship.blade.php ENDPATH**/ ?>