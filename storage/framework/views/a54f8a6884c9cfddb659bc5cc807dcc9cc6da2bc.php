...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.payments.paystackStatus'),'fieldName' => 'paystack_status','fieldId' => 'paystack_status','fieldValue' => 'active','checked' => $credentials->paystack_status == 'active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="row <?php if($credentials->paystack_status == 'deactive'): ?> d-none <?php endif; ?>" id="paystack_details">
        <div class="col-lg-12">
            <?php if (isset($component)) { $__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381 = $component; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'paystack_mode','fieldLabel' => __('app.selectEnvironment'),'fieldName' => 'paystack_mode'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <option value="sandbox" <?php if($credentials->paystack_mode == 'sandbox'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.sandbox'); ?></option>
                <option value="live" <?php if($credentials->paystack_mode == 'live'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.live'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 paystack_live <?php echo e($credentials->paystack_mode == 'live' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.paystackKey'),'fieldName' => 'paystack_key','fieldId' => 'paystack_key','fieldValue' => $credentials->paystack_key,'fieldPlaceholder' => __('placeholders.paymentGateway.paystackKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('modules.payments.PaystackSecretKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="paystack_secret" id="paystack_secret" class="form-control height-35 f-14"
                    value="<?php echo e($credentials->paystack_secret); ?>" autocomplete="off">
                 <?php $__env->slot('preappend', null, []); ?> 
                    <button type="button" data-toggle="tooltip" data-original-title="<?php echo e(__('messages.viewKey')); ?>"
...
<?php endif; ?>
        ...
        <div class="col-lg-12 paystack_live <?php echo e($credentials->paystack_mode == 'live' ? '' : 'd-none'); ?>"">
            <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.paystackMerchantEmail'),'fieldName' => 'paystack_merchant_email','fieldId' => 'paystack_merchant_email','fieldValue' => $credentials->paystack_merchant_email,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => '']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab)): ?>
<?php $component = $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab; ?>
<?php unset($__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab); ?>
<?php endif; ?>
        ...
        <div class="col-lg-6 paystack_sandbox <?php echo e($credentials->paystack_mode == 'sandbox' ? '' : 'd-none'); ?>"">
            <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.test') . ' ' . __('modules.payments.paystackKey'),'fieldName' => 'test_paystack_key','fieldId' => 'test_paystack_key','fieldValue' => $credentials->test_paystack_key,'fieldPlaceholder' => __('placeholders.paymentGateway.paystackKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 paystack_sandbox <?php echo e($credentials->paystack_mode == 'sandbox' ? '' : 'd-none'); ?>"">
            <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.test') . ' ' . __('modules.payments.PaystackSecretKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="test_paystack_secret" id="test_paystack_secret" class="form-control height-35 f-14"
                    value="<?php echo e($credentials->test_paystack_secret); ?>" autocomplete="off">
                 <?php $__env->slot('preappend', null, []); ?> 
                    <button type="button" data-toggle="tooltip" data-original-title="<?php echo e(__('messages.viewKey')); ?>"
                        class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
                            class="fa fa-eye"></i></button>
...
<?php endif; ?>
        ...
        <div class="col-lg-12 paystack_sandbox <?php echo e($credentials->paystack_mode == 'sandbox' ? '' : 'd-none'); ?>"">
            <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.test') . ' ' . __('modules.payments.paystackMerchantEmail'),'fieldName' => 'test_paystack_merchant_email','fieldId' => 'test_paystack_merchant_email','fieldValue' => $credentials->test_paystack_merchant_email,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'mail_from_name','class' => 'mt-3']); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad)): ?>
<?php $component = $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad; ?>
...
<?php endif; ?>
            <p class="text-bold">
                <span id="webhook-link-text"><?php echo e($webhookRoute); ?></span>
            ...
            <p class="text-primary">(<?php echo app('translator')->get('messages.addPaystackWebhookUrl'); ?>)</p>
        </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 w-100','id' => 'save_paystack_data']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/payment-gateway-settings/ajax/paystack.blade.php ENDPATH**/ ?>