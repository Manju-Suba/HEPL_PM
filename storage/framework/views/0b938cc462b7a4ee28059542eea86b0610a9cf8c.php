...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('app.status'),'fieldName' => 'status','fieldId' => 'push_status','fieldValue' => 'active','checked' => $pushSettings->status == 'active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="row push_details mt-3 <?php if($pushSettings->status == 'inactive'): ?> d-none <?php endif; ?>">
            <div class="col-lg-6 col-md-6">
                <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.pushSettings.oneSignalAppId'),'fieldPlaceholder' => __('placeholders.id'),'fieldName' => 'onesignal_app_id','fieldId' => 'onesignal_app_id','fieldRequired' => 'true','fieldValue' => $pushSettings->onesignal_app_id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="col-lg-6 col-md-6">
                <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.pushSettings.oneSignalRestApiKey'),'fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.key'),'fieldName' => 'onesignal_rest_api_key','fieldId' => 'onesignal_rest_api_key','fieldValue' => $pushSettings->onesignal_rest_api_key] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
    ...
    <div class="col-xl-4 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
        <h4 class="f-16 text-capitalize f-w-500 text-dark-grey"><?php echo app('translator')->get("modules.pushSettings.notificationTitle"); ?></h4>
        <?php $__currentLoopData = $emailSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emailSetting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mb-3 d-flex">
                <?php if (isset($component)) { $__componentOriginaldf5bb0e32b087bca724e42ed3cdc51682b267e1e = $component; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['checked' => $emailSetting->send_push == 'yes','fieldLabel' => __('modules.emailNotification.'.str_slug($emailSetting->setting_name)),'fieldName' => 'send_push[]','fieldId' => 'send_push_'.$emailSetting->id,'fieldValue' => $emailSetting->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-push-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if($pushSettings->status == 'active'): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'send-test-notification']); ?>
                <?php echo app('translator')->get('modules.slackSettings.sendTestNotification'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <script>
        $('body').on('click', '#save-push-form', function() {
            $.easyAjax({
                url: "<?php echo e(route('push-notification-settings.update', $emailSetting->id)); ?>",
                type: "POST",
        ...
        $('body').on('click', '#send-test-notification', function() {
            $.easyAjax({
                url: "<?php echo e(route('push_notification_settings.send_test_notification')); ?>",
                type: "GET",
            })
        });
    </script>
<?php /**PATH /var/www/HEPL_PM/resources/views/notification-settings/ajax/push-notification-setting.blade.php ENDPATH**/ ?>