<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('modules.attendance.shift'); ?></h5>
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
</div>

<div class="modal-body">
    <?php echo $__env->make('attendance-settings.ajax.shift', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<?php endif; ?>
</div><?php /**PATH /var/www/HEPL_PM/resources/views/employee-shifts/index.blade.php ENDPATH**/ ?>