            ...
            <tr class="row<?php echo e($shift->id); ?>">
                ...
                <td>
                    <div class="f-11"><?php echo app('translator')->get('modules.employees.startTime'); ?>:
                        <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $shift->office_start_time)->format(company()->time_format)); ?>

                    </div>
                    <div class="f-11">
                        <?php echo app('translator')->get('modules.attendance.halfDay'); ?>:
                        <?php echo e($shift->halfday_mark_time? \Carbon\Carbon::createFromFormat('H:i:s', $shift->halfday_mark_time)->format(company()->time_format): ''); ?>

                    </div>
                    <div class="f-11">
                        <?php echo app('translator')->get('modules.employees.endTime'); ?>:
                        <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $shift->office_end_time)->format(company()->time_format)); ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/attendance-settings/ajax/shift.blade.php ENDPATH**/ ?>