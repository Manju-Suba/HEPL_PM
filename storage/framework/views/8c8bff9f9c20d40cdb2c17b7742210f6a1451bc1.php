...
<?php endif; ?>
    ...
    <div class="page-header-right float-right d-flex align-items-center">
        ...
        <?php if(!is_null($selfActiveTimer)): ?>

            <span class="border rounded f-14 py-2 px-2 d-none d-sm-block mr-3">
                <span id="active-timer" class="mr-2"><?php echo e($selfActiveTimer->timer); ?></span>

                <?php if(is_null($selfActiveTimer->activeBreak)): ?>
                    <a href="javascript:;" class="pause-active-timer mr-1 border-right" data-toggle="tooltip" data-original-title="<?php echo e(__('modules.timeLogs.pauseTimer')); ?>" data-time-id="<?php echo e($selfActiveTimer->id); ?>">
                        <i class="fa fa-pause-circle text-primary"></i>
                    </a>
                    <a href="javascript:;" class="stop-active-timer" data-toggle="tooltip" data-original-title="<?php echo e(__('modules.timeLogs.stopTimer')); ?>" data-time-id="<?php echo e($selfActiveTimer->id); ?>">
                        <i class="fa fa-stop-circle text-danger"></i>
                    </a>
                <?php else: ?>
                    <a href="javascript:;" class="resume-active-timer" data-toggle="tooltip" data-original-title="<?php echo e(__('modules.timeLogs.resumeTimer')); ?>" data-time-id="<?php echo e($selfActiveTimer->activeBreak->id); ?>">
            ...
            <?php if(is_null($selfActiveTimer->activeBreak)): ?>
                <a href="javascript:;" class='btn-danger btn btn-sm rounded mr-3 f-14 py-2 px-2 stop-active-timer d-block d-sm-none mr-2' data-time-id="<?php echo e($selfActiveTimer->id); ?>">
                    <?php echo e(__('modules.timeLogs.stopTimer')); ?>
...
<script>
    $(document).ready(function () {
        ...
        var activeBreak = "<?php echo e((!is_null($selfActiveTimer) && !is_null($selfActiveTimer->activeBreak))); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/sections/topbar.blade.php ENDPATH**/ ?>