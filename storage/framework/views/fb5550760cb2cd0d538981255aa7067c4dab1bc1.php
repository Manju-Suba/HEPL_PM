<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('modules.tasks.boardColumn'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'updateTaskBoardColumn']); ?>
        <div class="row">
            <div class="col-md-12">
                <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.tasks.columnName'),'fieldName' => 'column_name','fieldId' => 'column_name','fieldValue' => $boardColumn->column_name,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'priority','fieldLabel' => __('modules.tasks.position'),'fieldName' => 'priority','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['id' => 'colorpicker']); ?>
                        <input type="text" class="form-control height-35 f-14" value="<?php echo e($boardColumn->label_color); ?>"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'update-board-column']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#colorpicker').colorpicker({
        "color": "<?php echo e($boardColumn->label_color); ?>"
    });

    $('#update-board-column').click(function() {
        var url = "<?php echo e(route('taskboards.update', $boardColumn->id)); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/taskboard/edit.blade.php ENDPATH**/ ?>