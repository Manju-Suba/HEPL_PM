                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link f-15 active sendReminder"
                               href="<?php echo e(route('project-settings.index')); ?>" role="tab"
                               aria-controls="nav-sendReminder" aria-selected="true"><?php echo app('translator')->get($pageTitle); ?>
                            </a>
                            ...
                            <a class="nav-item nav-link f-15 status"
                               ...
                               aria-selected="true"><?php echo app('translator')->get('modules.projects.projectStatusSettings'); ?>
                            </a>

                            <a class="nav-item nav-link f-15 category"
                               href="<?php echo e(route('project-settings.index')); ?>?tab=category" role="tab"
                               aria-controls="nav-category"
                               aria-selected="true"><?php echo app('translator')->get('modules.projects.projectCategory'); ?>
                            </a>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'add-status','class' => 'status-btn mb-2 actionBtn d-none']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addProjectCategory','class' => 'category-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('modules.statusFields.addCategory'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalad6cd9ca0c0f4e557ce8aae8581c3617ecf44480)): ?>
<?php $component = $__componentOriginalad6cd9ca0c0f4e557ce8aae8581c3617ecf44480; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/project-settings/index.blade.php ENDPATH**/ ?>