...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reset-password-form','class' => 'ajax-form']); ?>
        <div class="row">
            <div class="col-lg-12">
...
<?php $component->withAttributes(['type' => 'info','icon' => 'info-circle']); ?>
                    <?php echo app('translator')->get('messages.codeSent'); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.twoFactorCodeEmail')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'submit-login']); ?><?php echo app('translator')->get('modules.twofactor.validate2FA'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('#submit-login').click(function() {
        ...
        var url = "<?php echo e(route('two-fa-settings.email_confirm')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /var/www/HEPL_PM/resources/views/security-settings/ajax/validate-email-confirm-modal.blade.php ENDPATH**/ ?>