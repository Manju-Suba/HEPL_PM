...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.payments.stripeStatus'),'fieldName' => 'stripe_status','fieldId' => 'stripe_status','fieldValue' => 'active','checked' => $credentials->stripe_status == 'active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="row <?php if($credentials->stripe_status == 'deactive'): ?> d-none <?php endif; ?>" id="stripe_details">

        <div class="col-lg-12">
            <?php if (isset($component)) { $__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381 = $component; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'stripe_mode','fieldLabel' => __('app.selectEnvironment'),'fieldName' => 'stripe_mode'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <option value="test"
                        <?php if($credentials->stripe_mode == 'test'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.test'); ?></option>
                <option value="live"
                        <?php if($credentials->stripe_mode == 'live'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.live'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-12">
            <div id="test_stripe_details" class="row <?php if($credentials->stripe_mode ==
                'live'): ?> d-none <?php endif; ?>">
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.test').' '.__('app.stripePublishableKey'),'fieldName' => 'test_stripe_client_id','fieldId' => 'test_stripe_client_id','fieldValue' => $credentials->test_stripe_client_id,'fieldPlaceholder' => __('placeholders.paymentGateway.testStripePublishableKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.test').' '.__('app.stripeSecret'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <input type="password" name="test_stripe_secret" id="test_stripe_secret"
                               ...
                               value="<?php echo e($credentials->test_stripe_secret); ?>" autocomplete="off">
...
<?php endif; ?>
                ...
                <div class="col-lg-12">
                    <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.test').' '.__('app.stripeWebhookSecret')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                        <input type="password" name="test_stripe_webhook_secret" id="test_stripe_webhook_secret"
                               class="form-control height-35 f-14"
                               value="<?php echo e($credentials->test_stripe_webhook_secret); ?>" autocomplete="off">
                         <?php $__env->slot('preappend', null, []); ?> 
                            <button type="button" data-toggle="tooltip"
                                    data-original-title="<?php echo e(__('messages.viewKey')); ?>"
                                    class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
...
<?php endif; ?>
        ...
        <div class="col-lg-12">
            <div id="live_stripe_details" class="row <?php if($credentials->stripe_mode ==
                'test'): ?> d-none <?php endif; ?>">
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.live').' '.__('app.stripePublishableKey'),'fieldName' => 'live_stripe_client_id','fieldId' => 'live_stripe_client_id','fieldValue' => $credentials->live_stripe_client_id,'fieldPlaceholder' => __('placeholders.paymentGateway.liveStripePublishableKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                ...
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.live').' '.__('app.stripeSecret'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <input type="password" name="live_stripe_secret" id="live_stripe_secret"
                               class="form-control height-35 f-14"
                               value="<?php echo e($credentials->live_stripe_secret); ?>" autocomplete="off">
                         <?php $__env->slot('preappend', null, []); ?> 
                            <button type="button" data-toggle="tooltip"
                                    data-original-title="<?php echo e(__('messages.viewKey')); ?>"
                                    class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
...
<?php endif; ?>
                ...
                <div class="col-lg-12">
                    <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.live').' '.__('app.stripeWebhookSecret')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                        <input type="password" name="live_stripe_webhook_secret" id="live_stripe_webhook_secret"
                               class="form-control height-35 f-14"
                               value="<?php echo e($credentials->live_stripe_webhook_secret); ?>" autocomplete="off">
...
<?php endif; ?>
            ...
            <div class="m-1">
                <ul class="my-4 small text-lightest">
                    <li><?php echo app('translator')->get('messages.addStripeWebhookUrlHelpVisit1'); ?></li>
                    <li> <?php echo app('translator')->get('messages.addStripeWebhookUrlHelpVisit2'); ?></li>
                </ul>
            </div>
        </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 w-100','id' => 'save_stripe_data']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/payment-gateway-settings/ajax/stripe.blade.php ENDPATH**/ ?>