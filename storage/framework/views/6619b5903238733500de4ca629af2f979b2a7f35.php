...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.accountSettings.companyName'),'fieldPlaceholder' => 'e.g. Acme Corporation','fieldRequired' => 'true','fieldName' => 'company_name','popover' => __('messages.companyNameTooltip'),'fieldId' => 'company_name','fieldValue' => company()->company_name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/company-settings/index.blade.php ENDPATH**/ ?>