    ...
    <div class="card-body p-2">
        <div class="d-flex justify-content-between mb-2">
            <a href="javascript:;" data-task-id="<?php echo e($task->hash); ?>"
                class="f-12 f-w-500 text-dark mb-0 text-wrap taskDetail"><?php echo e(ucfirst($task->heading)); ?></a>
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex flex-wrap">
                <?php $__currentLoopData = $task->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="avatar-img mr-1 rounded-circle">
                        <a href="javascript:;" alt="<?php echo e(mb_ucwords($item->name)); ?>"
            ...
            <?php elseif($task->due_date->endOfDay()->isPast()): ?>
                <div class="d-flex text-red">
                    ...
                    <i class="f-11 bi bi-calendar"></i><span
                        class="f-12 ml-1"><?php echo e($task->due_date->format($task->company->date_format)); ?></span>
                </div>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/components/cards/public-task-card.blade.php ENDPATH**/ ?>