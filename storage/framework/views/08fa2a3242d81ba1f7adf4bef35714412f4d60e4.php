...
<div class="card sticky-note border">
    ...
    <div class="card-footer bg-white border-0">
        <div class="d-flex justify-content-between">
            <div class="text-lightest"><?php echo e($stickyNote->created_at->format(company()->date_format)); ?></div>
            <div class="text-<?php echo e($colour); ?>"><i class="fa fa-circle"></i></div>
        </div>
    </div>
</div>
<?php /**PATH /var/www/HEPL_PM/resources/views/components/cards/sticky-note.blade.php ENDPATH**/ ?>