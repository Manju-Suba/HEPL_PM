    ...
    <div class="board-panel rounded bg-additional-grey border-grey mr-3 column-max-<?php echo e($column->id); ?>">
        ...
        <div class="d-flex m-3 b-p-header">
            <p class="mb-0 f-15 mr-3 text-dark-grey font-weight-bold"><i class="fa fa-circle mr-2 text-yellow"
                    style="color: <?php echo e($column->label_color); ?>"></i><?php echo e($column->slug == 'completed' || $column->slug == 'incomplete' ? __('app.' . $column->slug) : mb_ucwords($column->column_name)); ?>
        ...
        <div class="b-p-body">
            ...
            <div class="b-p-tasks" id="drag-container-<?php echo e($column->id); ?>" data-column-id="<?php echo e($column->id); ?>">
                <?php $__empty_1 = true; $__currentLoopData = $column['tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if (isset($component)) { $__componentOriginal55f0008226d193056a25c95675d2813e178b5a7f = $component; } ?>
...
<?php endif; ?>
<?php if (isset($__componentOriginal55f0008226d193056a25c95675d2813e178b5a7f)): ?>
<?php $component = $__componentOriginal55f0008226d193056a25c95675d2813e178b5a7f; ?>
<?php unset($__componentOriginal55f0008226d193056a25c95675d2813e178b5a7f); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/taskboard_data.blade.php ENDPATH**/ ?>