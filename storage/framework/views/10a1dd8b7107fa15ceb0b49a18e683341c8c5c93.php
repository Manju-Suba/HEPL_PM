...
<?php $component->withAttributes(['class' => 'table-bordered mt-3 table-hover']); ?>
         <?php $__env->slot('thead', null, []); ?> 
            ...
            <th class="pr-2 pl-1"><?php echo e($i); ?> <br> <span class="text-dark-grey"><?php echo e($weekMap[\Carbon\Carbon::parse(\Carbon\Carbon::parse($i . '-' . $month . '-' . $year))->dayOfWeek]); ?></span></th>
            <?php endfor; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/attendances/ajax/summary_data.blade.php ENDPATH**/ ?>