...
<div class="container">
    <div class="row" style="margin-top: 30px">
        <div class="text-center m-t-20 mt-20">
            <img class="text-center" src="<?php echo e(asset('img/worksuite-logo.png')); ?>" style="max-height: 40px" alt="Home"/>
        </div>
        <div class="bs-example" data-example-id="alerts-with-links" style="margin-top:10px ">


            <div class="alert alert-warning" role="alert">
                <strong><?php echo e(mb_ucwords(config('froiden_envato.envato_product_name'))); ?> not installed!</strong> Visit <a
...
<?php /**PATH /var/www/HEPL_PM/resources/views/vendor/froiden-envato/install_message.blade.php ENDPATH**/ ?>