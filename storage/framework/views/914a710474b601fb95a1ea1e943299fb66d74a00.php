                ...
                <div class="card-header bg-white  border-bottom-grey text-capitalize justify-content-between p-20">
                    <div class="row">
                        <div class="col-md-10 col-10">
                            <h3 class="heading-h1"><?php echo app('translator')->get('app.menu.department'); ?> <?php echo app('translator')->get('app.details'); ?></h3>
                        </div>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/departments/ajax/show.blade.php ENDPATH**/ ?>