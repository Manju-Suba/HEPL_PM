                                    ...
                                    <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                        ...
                                        <?php if($viewFilePermission == 'all' || ($viewFilePermission == 'added' && $file->added_by == user()->id)): ?>
                                           ...
                                           <a class="cursor-pointer d-block text-dark-grey f-13 py-3 px-3 "
                                                href="<?php echo e($file->file_url); ?>" download><?php echo app('translator')->get('app.download'); ?></a>
                                        <?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/projects/ajax/files.blade.php ENDPATH**/ ?>