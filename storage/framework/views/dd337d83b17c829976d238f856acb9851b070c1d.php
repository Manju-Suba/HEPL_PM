                            ...
                            <li>
                                <a class="nav-item nav-link f-15 stripe" data-toggle="tab"
                                   ...
                                   aria-controls="nav-stripe" aria-selected="false"><i
                                        class="fab fa-stripe-s f-12"></i> <?php echo app('translator')->get('app.stripe'); ?> <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 mollie" data-toggle="tab"
                                   ...
                                   aria-controls="nav-mollie" aria-selected="false"><img style="height: 10px;"
                                                                                         src="<?php echo e(asset('img/mollie.svg')); ?>"> <?php echo app('translator')->get('app.mollie'); ?>
                                    <i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/payment-gateway-settings/index.blade.php ENDPATH**/ ?>