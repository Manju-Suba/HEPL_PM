...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('modules.statusFields.createStatus'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createStatus','class' => 'ajax-form']); ?>
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'status-active','fieldLabel' => __('app.active'),'fieldValue' => 'active','fieldName' => 'status','checked' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginald8738d15765d6b35d603018b407a63f14ee18785 = $component; } ?>
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'status-inactive','fieldLabel' => __('app.inactive'),'fieldValue' => 'inactive','fieldName' => 'status'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.radio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Radio::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-status-setting']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-status-setting').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('project-settings.store')); ?>",
...
<?php /**PATH /var/www/HEPL_PM/resources/views/project-settings/create-project-status-settings-modal.blade.php ENDPATH**/ ?>