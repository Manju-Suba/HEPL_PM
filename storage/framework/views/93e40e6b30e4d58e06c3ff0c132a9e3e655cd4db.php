...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('tasks.show', $notification->data['id']) . '?view=sub_task','image' => user()->image_url,'title' => __('email.subTaskAssigneeAdded.subject'). ' - '. __('app.task').'#'.$notification->data['id'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/HEPL_PM/resources/views/notifications/all/sub_task_assignee_added.blade.php ENDPATH**/ ?>