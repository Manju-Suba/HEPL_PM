...
<div class="card rounded bg-white border-grey b-shadow-4 m-1 mb-2 <?php echo e($moveClass); ?> task-card"
    data-task-id="<?php echo e($task->id); ?>" id="drag-task-<?php echo e($task->id); ?>" style="border-left: 3px solid <?php echo e($task->priority == 'high' ? '#dd0000' : ($task->priority == 'medium' ? '#ffc202' : '#0a8a1f')); ?>">
            ...
            <?php if($task->project_id): ?>
                <div>
                    <i class="fa fa-layer-group f-11 text-lightest"></i><span
                        class="ml-2 f-11 text-lightest"><?php echo e(ucfirst($task->project_name)); ?></span>
                </div>
            <?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/components/cards/task-card.blade.php ENDPATH**/ ?>