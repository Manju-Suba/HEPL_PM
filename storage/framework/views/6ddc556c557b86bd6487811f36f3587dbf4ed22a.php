<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.roles.addRole'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($role->id); ?>">
                <td><?php echo e($key + 1); ?></td>
                <td data-row-id="<?php echo e($role->id); ?>" <?php if(!in_array($role->name, ['admin', 'employee', 'client'])): ?> contenteditable="true" <?php endif; ?>><?php echo e(mb_ucwords($role->name)); ?>

                </td>
                <td><span class="text-lightest"><span class="badge badge-primary"><?php echo e($role->unsynced_users_count); ?></span> <?php echo app('translator')->get('app.unsyncedUsers'); ?></span></td>
                <td class="text-right">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-cat-id' => ''.e($role->id).'','class' => 'delete-category']); ?>
...
<?php endif; ?>
                    <?php else: ?>
                        <span class="text-lightest"><?php echo app('translator')->get('messages.defaultRoleCantDelete'); ?></span>

                        <?php if(in_array($role->name, ['employee', 'client'])): ?>
                            <?php if (isset($component)) { $__componentOriginal145d6f964f40dbb2191316e2895f0c633dbd4d26 = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'reset-permission ml-2','data-role-id' => ''.e($role->id).'']); ?>
                                <?php echo app('translator')->get('app.reset'); ?> <?php echo app('translator')->get('modules.permission.permissions'); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal145d6f964f40dbb2191316e2895f0c633dbd4d26)): ?>
<?php $component = $__componentOriginal145d6f964f40dbb2191316e2895f0c633dbd4d26; ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'role_name','fieldLabel' => __('modules.permission.roleName'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => 'e.g. HR'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'import_from_role','fieldLabel' => __('modules.permission.importFromRole'),'fieldName' => 'import_from_role'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('.delete-category').click(function() {
        ...
        var url = "<?php echo e(route('role-permissions.delete_role')); ?>";
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('role-permissions.store_role')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('role-permissions.update', ':id')); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/role-permissions/ajax/create.blade.php ENDPATH**/ ?>