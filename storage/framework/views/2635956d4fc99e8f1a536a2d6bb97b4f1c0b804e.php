...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg','fieldLabel' => __('modules.profile.profilePicture'),'fieldValue' => ($user->image ? $user->image_url : $userImage),'fieldName' => 'image','fieldId' => 'profile-image','popover' => __('modules.themeSettings.logoSize')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/profile-settings/ajax/profile.blade.php ENDPATH**/ ?>