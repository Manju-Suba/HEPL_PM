<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('app.client'); ?></h5>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/clients/ajax/quick_create.blade.php ENDPATH**/ ?>