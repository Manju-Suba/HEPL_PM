    ...
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex justify-content-between">
            <div id="table-actions" class="align-items-center">
                <?php if(($addExpensesPermission == 'all' || $addExpensesPermission == 'added') && !$project->trashed()): ?>
                    <?php if (isset($component)) { $__componentOriginal7f662ecf9f97aca611d2405e5e6903e6081fbd17 = $component; } ?>
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('expenses.create').'?project_id='.$project->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 float-left openRightModal','data-redirect-url' => ''.e(url()->full()).'']); ?>
...
<script>
    $('#expenses-table').on('preXhr.dt', function(e, settings, data) {
        ...
        data['projectId'] = "<?php echo e($project->id); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/projects/ajax/expenses.blade.php ENDPATH**/ ?>