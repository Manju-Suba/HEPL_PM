...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-department-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('modules.department.title'); ?></h4>
                <div class="row p-20">
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'designation_name','fieldLabel' => __('app.name'),'fieldName' => 'team_name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.department')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'parent_label','fieldLabel' => __('app.parentId')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'my-3','fieldName' => 'parent_label']); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-department-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\ButtonCancel::resolve(['link' => route('departments.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-department-form').click(function() {
        var url = "<?php echo e(route('departments.store')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /var/www/HEPL_PM/resources/views/departments/ajax/create.blade.php ENDPATH**/ ?>