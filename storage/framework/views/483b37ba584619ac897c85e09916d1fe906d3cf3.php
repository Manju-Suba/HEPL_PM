<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('modules.timeLogs.break'); ?></h5>
...
<?php endif; ?>
            ...
            <div class="col-sm-6">
                <div class="bootstrap-timepicker timepicker">
                    <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.timeLogs.endTime'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'end_time','fieldId' => 'end_time','fieldRequired' => 'true','fieldValue' => $timelogBreak->end_time->timezone(company()->timezone)->format(company()->time_format)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3','id' => 'delete-break']); ?><?php echo app('translator')->get('app.delete'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('timelog-break.update', $timelogBreak->id)); ?>";
        $.easyAjax({
            url: url,
    ...
    $('body').on('click', '#delete-break', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('timelog-break.destroy', $timelogBreak->id)); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/timelog-break/edit.blade.php ENDPATH**/ ?>