...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.projects.projectCategory'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td class="text-right">
                    <?php if($deleteProjectCategoryPermission == 'all' || ($deleteProjectCategoryPermission == 'added' && $category->added_by == user()->id)): ?>
...
<script>
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('projectCategory.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('projectCategory.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /var/www/HEPL_PM/resources/views/projects/create_category.blade.php ENDPATH**/ ?>