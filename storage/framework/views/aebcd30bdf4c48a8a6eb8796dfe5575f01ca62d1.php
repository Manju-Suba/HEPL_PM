...
<?php endif; ?>
                        ...
                        <?php if(in_array('attendance', user_modules()) && in_array('shift_schedule', $activeWidgets) && $sidebarUserPermissions['view_shift_roster'] != 5 && $sidebarUserPermissions['view_shift_roster'] != 'none'): ?>
                            <div class="col-sm-12">
                                <?php if (isset($component)) { $__componentOriginalf463d4507b04ddbb1ec93225959f845404a19c7e = $component; } ?>
                                        ...
                                        <?php $__currentLoopData = $currentWeekDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $weekDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(isset($weekShifts[$key])): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(__('app.'.strtolower($weekDate->format('l')))); ?></td>
                                                    <td>
...
<?php endif; ?>
            ...
            <div class="col-xl-7 col-lg-12 col-md-12 e-d-tasks-projects-events">
                ...
                <div class="row mb-3 mt-xl-0 mt-lg-4 mt-md-4 mt-4">
                    <?php if(in_array('tasks', $activeWidgets) && (!is_null($viewTaskPermission) && $viewTaskPermission != 'none')): ?>
                    ...
                    <?php endif; ?>
                    <?php if(in_array('projects', $activeWidgets) && $sidebarUserPermissions['view_projects'] != 5 && $sidebarUserPermissions['view_projects'] != 'none'): ?>
                        <div class="col-md-6 mb-3">
                            <div
                    ...
                    <?php endif; ?>
                    <?php if(in_array('week_timelog', $activeWidgets) && $sidebarUserPermissions['view_timelogs'] != 5 && $sidebarUserPermissions['view_timelogs'] != 'none'): ?>
                ...
                <?php if(in_array('my_task', $activeWidgets) && (!is_null($viewTaskPermission) && $viewTaskPermission != 'none')): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card border-0 b-shadow-4 mb-3 e-d-info">
                            <?php if (isset($component)) { $__componentOriginalf463d4507b04ddbb1ec93225959f845404a19c7e = $component; } ?>
...
<?php endif; ?>
                ...
                <?php if(in_array('ticket', $activeWidgets) && $sidebarUserPermissions['view_tickets'] != 5 && $sidebarUserPermissions['view_tickets'] != 'none'): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card border-0 b-shadow-4 mb-3 e-d-info">
                            <?php if (isset($component)) { $__componentOriginalf463d4507b04ddbb1ec93225959f845404a19c7e = $component; } ?>
...
<?php $component->withAttributes([]); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                                ...
                                                <div class="media align-items-center">
                                                    <div class="media-body">
                                                        <h5 class="f-12 mb-1 text-darkest-grey">
                                                            <a href="<?php echo e(route('tickets.show', [$ticket->ticket_number])); ?>"><?php echo e(ucfirst($ticket->subject)); ?></a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="pr-20" align="right">
                                                <span><?php echo e($ticket->updated_at->format(company()->date_format)); ?></span>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
...
<?php endif; ?>
                ...
                <?php if(in_array('notices', $activeWidgets) && $sidebarUserPermissions['view_notice'] != 5 && $sidebarUserPermissions['view_notice'] != 'none'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/dashboard/employee/index.blade.php ENDPATH**/ ?>