...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('tasks.show', $notification->data['id']),'image' => user()->image_url,'title' => __('email.subTaskComplete.subject'),'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/HEPL_PM/resources/views/notifications/all/sub_task_completed.blade.php ENDPATH**/ ?>