...
<?php $component = App\View\Components\UserOption::resolve(['user' => $emp->user,'selected' => ($emp->id == user()->id),'userID' => $emp->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php elseif(in_array(user()->id, $leadAgentArray)): ?>
                        <input type="hidden" value="<?php echo e(user()->id); ?>" name="agent_id">
                    <?php endif; ?>
...
<?php $component = App\View\Components\Forms\Tel::resolve(['fieldId' => 'mobile','fieldLabel' => __('modules.lead.mobile'),'fieldName' => 'mobile','fieldPlaceholder' => __('placeholders.mobile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/leads/ajax/create.blade.php ENDPATH**/ ?>