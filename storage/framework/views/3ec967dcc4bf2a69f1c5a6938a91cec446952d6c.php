...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('project-template.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 openRightModal']); ?>
                        <?php echo app('translator')->get('app.menu.addProjectTemplate'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('project-template.destroy', ':id')); ?>";
        ...
        const applyQuickAction = () => {
            ...
            var url = "<?php echo e(route('project_template.apply_quick_action')); ?>?row_ids=" + rowdIds;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/project-templates/index.blade.php ENDPATH**/ ?>