...
<?php $component->withAttributes(['class' => 'mt-3']); ?>
            <div class="row">
               <div class="col-md-12">
                    ...
                    <?php echo app('translator')->get('modules.attendance.present'); ?> &nbsp;|&nbsp; <i class="fa fa-star-half-alt text-primary"></i> <i
                        class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
                    <?php echo app('translator')->get('modules.attendance.halfDay'); ?> &nbsp;|&nbsp; <i class="fa fa-exclamation-circle text-primary"></i> <i
                        class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('#export-all').click(function () {
            ...
            var url =
                "<?php echo e(route('attendances.export_all_attendance', [':year', ':month', ':userId', ':late', ':department', ':designation'])); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/attendances/index.blade.php ENDPATH**/ ?>