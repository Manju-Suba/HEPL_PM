...
<?php $component = App\View\Components\Forms\ButtonCancel::resolve(['link' => route('project-template.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-project-form').click(function() {
            ...
            const url = "<?php echo e(route('project-template.store')); ?>";
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    window.location.href = "<?php echo e(route('project-template.index')); ?>";
                }
            });
        });
...
<?php /**PATH /var/www/HEPL_PM/resources/views/project-templates/ajax/create.blade.php ENDPATH**/ ?>