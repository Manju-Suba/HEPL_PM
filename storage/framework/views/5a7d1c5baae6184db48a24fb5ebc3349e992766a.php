...
<?php $component = App\View\Components\Forms\Tel::resolve(['fieldId' => 'mobile','fieldLabel' => __('app.mobile'),'fieldName' => 'mobile','fieldPlaceholder' => __('placeholders.mobile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e(($role->name == 'employee') ? 'selected' : ''); ?> value="<?php echo e($role->id); ?>"><?php echo e($role->display_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381)): ?>
...
<?php $component->withAttributes(['fieldPlaceholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('placeholders.date'))]); ?>
                            <option value="">--</option>
                            <option value="full_time"><?php echo app('translator')->get('app.fullTime'); ?></option>
                            <option value="part_time"><?php echo app('translator')->get('app.partTime'); ?></option>
                            <option value="on_contract"><?php echo app('translator')->get('app.onContract'); ?></option>
                            <option value="internship"><?php echo app('translator')->get('app.internship'); ?></option>
                            <option value="trainee"><?php echo app('translator')->get('app.trainee'); ?></option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381)): ?>
<?php $component = $__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/employees/ajax/create.blade.php ENDPATH**/ ?>