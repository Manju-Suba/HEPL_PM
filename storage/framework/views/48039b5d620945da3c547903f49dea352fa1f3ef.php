...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('modules.statusFields.editStatus'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'editStatus','class' => 'ajax-form']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldName' => 'name','fieldId' => 'name','fieldRequired' => 'true','fieldValue' => $projectStatusSetting->status_name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'statusColorSelector','fieldLabel' => __('modules.tasks.labelColor'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                <input type="text" name="status_color" id="editStatusColorSelector"
                                       value="<?php echo e($projectStatusSetting->color); ?>"
...
<?php endif; ?>
                ...
                <?php if($projectStatusSetting->default_status == 0): ?>
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'status-active','fieldLabel' => __('app.active'),'fieldValue' => 'active','fieldName' => 'status','checked' => '($projectStatusSetting->status == \'active\') ? \'checked\' : \'\''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginald8738d15765d6b35d603018b407a63f14ee18785 = $component; } ?>
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'status-inactive','fieldLabel' => __('app.inactive'),'fieldValue' => 'inactive','fieldName' => 'status','checked' => ($projectStatusSetting->status == 'inactive') ? 'checked' : ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.radio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Radio::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit-status-setting']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('#colorpickeredit').colorpicker({"color": "<?php echo e($projectStatusSetting->color); ?>"});
    ...
    $('#edit-status-setting').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('project-settings.statusUpdate', $projectStatusSetting->id)); ?>",
...
<?php /**PATH /var/www/HEPL_PM/resources/views/project-settings/edit.blade.php ENDPATH**/ ?>