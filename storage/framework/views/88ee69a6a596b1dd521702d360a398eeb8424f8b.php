            ...
            <div class="select-filter mb-4">
                <select class="form-control select-picker" name="award_type" id="award_type">
                    ...
                    <?php $__currentLoopData = $appreciations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option data-content="<i class='bi bi-<?php echo e($item->awardIcon->icon); ?>' style='color: <?php echo e($item->color_code); ?>'></i> <?php echo e($item->title); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/HEPL_PM/resources/views/appreciations/index.blade.php ENDPATH**/ ?>