...
<?php endif; ?>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'project-id','fieldRequired' => 'true','fieldLabel' => __('app.project')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <option <?php if($task->board_column_id == $item->id): ?> selected <?php endif; ?> value="<?php echo e($item->id); ?>" data-content = "<?php echo e($icon); ?>">
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <option <?php if($task->priority == 'high'): ?> selected <?php endif; ?>
                                    ...
                                    <option <?php if($task->priority == 'medium'): ?> selected <?php endif; ?>
                                    ...
                                    <option <?php if($task->priority == 'low'): ?> selected <?php endif; ?>
...
<?php /**PATH /var/www/HEPL_PM/resources/views/tasks/ajax/edit.blade.php ENDPATH**/ ?>