...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('app.status'),'fieldName' => 'slack_status','fieldId' => 'slack_status','fieldValue' => 'active','checked' => $slackSettings->status=='active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-12 slack_details <?php if($slackSettings->status=='inactive'): ?> d-none <?php endif; ?>">
            <div class="row mt-3">
                <div class="col-lg-12 col-md-12 ">
                    <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.slackSettings.slackWebhook'),'fieldPlaceholder' => __('placeholders.slackWebhook'),'fieldName' => 'slack_webhook','fieldId' => 'slack_webhook','fieldValue' => $slackSettings->slack_webhook,'fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg','fieldLabel' => __('modules.slackSettings.slackNotificationLogo'),'fieldValue' => $slackSettings->slack_logo_url,'fieldName' => 'slack_logo','fieldId' => 'slack_logo','popover' => __('messages.fileFormat.ImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div class="col-xl-4 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
    <h4 class="f-16 text-capitalize f-w-500 text-dark-grey"><?php echo app('translator')->get("modules.slackSettings.notificationTitle"); ?></h4>
    <?php $__currentLoopData = $emailSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emailSetting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="mb-3 d-flex">
            <?php if (isset($component)) { $__componentOriginaldf5bb0e32b087bca724e42ed3cdc51682b267e1e = $component; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['checked' => $emailSetting->send_slack == 'yes','fieldLabel' => __('modules.emailNotification.'.str_slug($emailSetting->setting_name)),'fieldName' => 'send_slack[]','fieldId' => 'send_slack'.$emailSetting->id,'fieldValue' => $emailSetting->id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-slack-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function () {
        $('body').on('click', '#save-slack-form', function () {
            var url = "<?php echo e(route('slack-settings.update', slack_setting()->id)); ?>";
        ...
        $('body').on('click', '#send-test-notification', function () {
            var url = '<?php echo e(route('slack_settings.send_test_notification')); ?>';
            $.easyAjax({
                url: url,
                type: "GET",
            })
...
<?php /**PATH /var/www/HEPL_PM/resources/views/notification-settings/ajax/slack-setting.blade.php ENDPATH**/ ?>