...
<?php $component->withAttributes([]); ?>
                                    ...
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($project->id == $timeLog->project_id): ?> selected <?php endif; ?> value="<?php echo e($project->id); ?>">
...
<?php $component->withAttributes([]); ?>
                                    <option value="">--</option>
                                    <?php if($timeLog->task_id): ?>
                                        <option selected value="<?php echo e($timeLog->task_id); ?>">
                                            <?php echo e($timeLog->task->heading); ?></option>
                                    <?php endif; ?>
                                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($item->id == $timeLog->task_id): ?> selected <?php endif; ?> value="<?php echo e($item->id); ?>">
...
<?php endif; ?>
                            ...
                            <?php if($editTimelogPermission == 'all'): ?>
                                <div class="col-md-6 col-lg-4">
...
<?php $component = App\View\Components\UserOption::resolve(['user' => $item,'selected' => $item->id == $timeLog->user_id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <input type="hidden" name="user_id" value="<?php echo e($timeLog->user_id); ?>">
                            <?php endif; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3 col-lg-3">
                                <?php if (isset($component)) { $__componentOriginal375ba69c4c90abc0fec300a948e1f40a31222641 = $component; } ?>
<?php $component = App\View\Components\Forms\Datepicker::resolve(['fieldId' => 'end_date','fieldRequired' => 'true','fieldLabel' => __('modules.timeLogs.endDate'),'fieldName' => 'end_date','fieldValue' => $timeLog->end_time->timezone(company()->timezone)->format(company()->date_format),'fieldPlaceholder' => __('placeholders.date')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.datepicker'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Datepicker::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3 col-lg-3">
                                <div class="bootstrap-timepicker timepicker">
                                    <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.timeLogs.endTime'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'end_time','fieldId' => 'end_time','fieldRequired' => 'true','fieldValue' => $timeLog->end_time->timezone(company()->timezone)->format(company()->time_format)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.timeLogs.memo'),'fieldName' => 'memo','fieldRequired' => 'true','fieldId' => 'memo','fieldValue' => $timeLog->memo,'fieldPlaceholder' => __('placeholders.timelog.memo')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php unset($__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad); ?>
<?php endif; ?>
                        <p id="total_time" class="f-w-500 text-primary f-21"><?php echo e($timeLog->hours); ?></p>
                    </div>

                </div>

                <?php if (isset($component)) { $__componentOriginal862ccabe24b67fc8444492fe81a4111be42270d7 = $component; } ?>
<?php $component = App\View\Components\Forms\CustomField::resolve(['fields' => $fields,'model' => $timeLog] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        const dp1 = datepicker('#start_date', {
            position: 'bl',
            dateSelected: new Date("<?php echo e(str_replace('-', '/', $timeLog->start_time)); ?>"),
        ...
        const dp2 = datepicker('#end_date', {
            position: 'bl',
            dateSelected: new Date("<?php echo e(str_replace('-', '/', $timeLog->end_time)); ?>"),
            onSelect: (instance, date) => {
                dp1.setMax(date);
                calculateTime();
            },
        ...
        $('#save-timelog-form').click(function() {
            const url = "<?php echo e(route('timelogs.update', $timeLog->id)); ?>";
...
<?php /**PATH /var/www/HEPL_PM/resources/views/timelogs/ajax/edit.blade.php ENDPATH**/ ?>