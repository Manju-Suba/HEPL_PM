...
<?php endif; ?>
                                ...
                                <td class="pr-20 text-right">
                                    ...
                                    <?php if($noticePeriodEndDate->setTimezone(company()->timezone)->isToday()): ?>
                                        <span
                                            class="text-success f-12"><?php echo e($noticePeriodStartDate->format($company->date_format) . ' - ' . $noticePeriodEndDate->format($company->date_format)); ?></span>
                                    <?php elseif($noticePeriodEndDate->diffInDays($currentDay) <= 7): ?>
                                        <span
                                            class="text-warning f-12"><?php echo e($noticePeriodStartDate->format($company->date_format) . ' - ' . $noticePeriodEndDate->format($company->date_format)); ?></span>
                                    <?php else: ?>
                                        <span
                                            class="f-12 "><?php echo e($noticePeriodStartDate->format($company->date_format) . ' - ' . $noticePeriodEndDate->format($company->date_format)); ?></span>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH /var/www/HEPL_PM/resources/views/dashboard/employee/widgets/notice-period.blade.php ENDPATH**/ ?>