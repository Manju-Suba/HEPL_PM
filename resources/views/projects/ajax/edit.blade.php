            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-12 col-lg-4">
                      ...
                      <div class="col-lg-4 col-md-6">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('project_url')"
                            fieldName="project_url" fieldId="project_url"
                            :fieldValue="$project->project_url" :fieldPlaceholder="__('Enter the project URL')" />
                    </div>
