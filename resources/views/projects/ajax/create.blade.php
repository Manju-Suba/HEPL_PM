                ...
                <div class="row p-20">
                    ...
                    @if ($addProjectMemberPermission == 'all' || $addProjectMemberPermission == 'added')
                        <div class="col-md-12" id="add_members">
                            ...
                            <div class="col-lg-6 col-md-6">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Project URL')"
                                      fieldName="project_url" fieldRequired="false" fieldId="project_url"
                                      :fieldPlaceholder="__('Enter the Project URL')"
                                      :fieldValue="$project ? $project->project_url : '' "/>
                    </div>
