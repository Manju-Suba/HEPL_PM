                    ...
                    <div class="col-xl-7 col-md-6 mb-4 mb-lg-0">
                        ...
                        <x-cards.data :title="__('modules.client.profileInfo')" class=" mt-4">
                            ...
                            @if ($showFullProfile)
                                ...
                                :value="$employee->employeeDetail->marriage_anniversary_date ? Carbon\Carbon::parse($employee->employeeDetail->marriage_anniversary_date)->format('d F') : '--'" />
                                ...
                                @if($employee->employeeDetail->employment_type == 'internship')
                                    ...
                                    :value="$employee->employeeDetail->internship_end_date ? Carbon\Carbon::parse($employee->employeeDetail->internship_end_date)->format(company()->date_format) : '--'" />
                                @endif

                                @if($employee->employeeDetail->employment_type == 'on contract')
                                    <x-cards.data-row :label="__('modules.employees.contractEndDate')"
                                    :value="$employee->employeeDetail->contract_end_date ? Carbon\Carbon::parse($employee->employeeDetail->contract_end_date)->format(company()->date_format) : '--'" />
                                @endif
