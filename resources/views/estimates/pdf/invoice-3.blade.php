                    ...
                    <td style="text-align: left;background: none;" >
                        ...
                        <p id="notes">
                            ...
                            @elseif($field->type == 'date')
                                {{ !is_null($estimate->custom_fields_data['field_'.$field->id]) ? \Carbon\Carbon::parse($estimate->custom_fields_data['field_'.$field->id])->format($estimate->company->date_format) : '--'}}
                            @endif
                        </p>
                    </td>
                </tr>
