                            ...
                            @foreach ($currencies as $currency)
                                ...
                                @else
                                    @if ($currency->id == company()->currency_id)
                                        selected @endif
                                        @if ($estimateTemplate && $currency->id == $estimateTemplate->currency_id) selected @endif
                            @endif
                            value="{{ $currency->id }}">
                                                        ...
                                                        <td width="30%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option @if (isset($estimateTemplate) && $estimateTemplate->discount_type == 'percent') selected @endif value="percent">%
                                                                    </option>
                                                                    <option @if (isset($estimateTemplate) && $estimateTemplate->discount_type == 'fixed') selected @endif value="fixed">
