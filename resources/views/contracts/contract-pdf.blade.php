                ...
                <td>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">{{ $contract->start_date->format($company->date_format) }}
                            </td>
                        </tr>
                        @if ($contract->end_date != null)
                            <tr>
                                ...
                                <td class="heading-table-right">
                                    {{ $contract->end_date->format($company->date_format) }}
                                </td>
                            </tr>
                        @endif
                        <tr>
                   ...
                   <td style="text-align: left;background: none;" >
                       ...
                       <p  class="f-14 line-height text-grey">
                           ...
                           @elseif($field->type == 'date')
                               {{ !is_null($contract->custom_fields_data['field_'.$field->id]) ? \Carbon\Carbon::parse($contract->custom_fields_data['field_'.$field->id])->format($contract->company->date_format) : '--'}}
                           @endif
                       </p>
                   </td>
               </tr>
