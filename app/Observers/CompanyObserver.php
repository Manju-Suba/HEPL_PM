...
class CompanyObserver
{
    ...
    private function customFieldGroup($company)
    {
        ...
        $fields = [
            ...
            ['name' => 'Contract', 'model' => Contract::CUSTOM_FIELD_MODEL, 'company_id' => $company->id]
    ...
    private function dashboardWidgets($company)
    {
        ...
        $widgets = [
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_clients', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_employees', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_projects', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_unpaid_invoices', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_hours_logged', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_pending_tasks', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_today_attendance', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_unresolved_tickets', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'recent_earnings', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'settings_leaves', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'new_tickets', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'overdue_tasks', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'pending_follow_up', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'project_activity_timeline', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'user_activity_timeline', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'timelogs', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'total_clients', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'total_leads', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'total_lead_conversions', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'total_contracts_generated', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'total_contracts_signed', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'client_wise_earnings', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'client_wise_timelogs', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'lead_vs_status', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'lead_vs_source', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'latest_client', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-client-dashboard', 'widget_name' => 'recent_login_activities', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'total_paid_invoices', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'total_expenses', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'total_earnings', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'total_pending_amount', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'invoice_overview', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'estimate_overview', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'proposal_overview', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'earnings_by_client', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'earnings_by_projects', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-finance-dashboard', 'widget_name' => 'total_unpaid_invoices', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'total_leaves_approved', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'total_new_employee', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'total_employee_exits', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'average_attendance', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'department_wise_employee', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'designation_wise_employee', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'gender_wise_employee', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'role_wise_employee', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'leaves_taken', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'late_attendance_mark', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'headcount', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'joining_vs_attrition', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'birthday', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-hr-dashboard', 'widget_name' => 'total_today_attendance', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'admin-project-dashboard', 'widget_name' => 'total_project', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-project-dashboard', 'widget_name' => 'total_hours_logged', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-project-dashboard', 'widget_name' => 'total_overdue_project', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-project-dashboard', 'widget_name' => 'status_wise_project', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-project-dashboard', 'widget_name' => 'pending_milestone', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'total_tickets', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'total_unassigned_ticket', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'type_wise_ticket', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'status_wise_ticket', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'channel_wise_ticket', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'admin-ticket-dashboard', 'widget_name' => 'new_tickets', 'company_id' => $company->id, 'status' => 1],

            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'profile', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'shift_schedule', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'birthday', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'notices', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'tasks', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'projects', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'my_task', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'my_calender', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'week_timelog', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'leave', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'lead', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'work_from_home', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'appreciation', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'work_anniversary', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'ticket', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'notice_period_duration', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'probation_date', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'contract_date', 'company_id' => $company->id, 'status' => 1],
            ['dashboard_type' => 'private-dashboard', 'widget_name' => 'internship_date', 'company_id' => $company->id, 'status' => 1],
        ];
