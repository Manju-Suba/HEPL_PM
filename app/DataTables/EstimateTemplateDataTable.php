...
class EstimateTemplateDataTable extends BaseDataTable
{
    ...
    public function query(EstimateTemplate $model)
    {
        ...
        $model = $model->select('estimate_templates.id', 'estimate_templates.name', 'estimate_templates.hash', 'total', 'currencies.currency_symbol', 'currencies.id as currencyId', 'estimate_templates.added_by')
    ...
    {
        return $this->builder()
            ->setTableId('estimate-template-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.estimates.name') => ['data' => 'name', 'name' => 'name', 'title' => __('modules.estimates.name')],
    ...
    {
        return 'estimate_templates_' . date('YmdHis');
    }
