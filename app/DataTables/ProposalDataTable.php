...
class ProposalDataTable extends BaseDataTable
{
    ...
    public function query()
    {
        ...
        $model = Proposal::select('proposals.id', 'proposals.hash', 'leads.client_name', 'leads.client_id', 'leads.id as lead_id', 'total', 'valid_till', 'status', 'currencies.currency_symbol', 'currencies.id as currencyId', 'leads.company_name', 'proposals.added_by')
            ->with('signature')
