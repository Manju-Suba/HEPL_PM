...
class BankAccountController extends AccountBaseController
{
    ...
    public function store(StoreAccount $request)
    {
        ...
        return Reply::successWithData(__('messages.bankAccountAdded'), ['redirectUrl' => route('bankaccounts.index')]);
    }
    ...
    public function show($id)
    {
        ...
        $this->creditVsDebitChart = $this->creditVsDebitChart();
    ...
    public function update(StoreAccount $request, $id)
    {
        ...
        return Reply::successWithData(__('messages.bankAccountUpdated'), ['redirectUrl' => route('bankaccounts.index')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return Reply::successWithData(__('messages.bankAccountDeleted'), ['redirectUrl' => route('bankaccounts.index')]);
    ...
    public function destroyTransaction(Request $request)
    {
        ...
        return Reply::successWithData(__('messages.bankTransactionDeleted'), ['redirectUrl' => route('bankaccounts.show', $bankTransaction->bank_account_id)]);
    }
    ...
    public function creditVsDebitChart()
    {
