...
class EstimateTemplateController extends AccountBaseController
{
    ...
    {
        $this->invoice = EstimateTemplate::with('items', 'clients', 'items.estimateTemplateItemImage')->findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        return Reply::redirect(route('estimate-template.index', $estimateTemplate->id), __('messages.estimateUpdated'));
    }
    ...
    {
        $this->invoiceSetting = invoice_setting();
        $this->estimateTemplate = EstimateTemplate::with('items', 'clients', 'currency')->findOrFail($id);
